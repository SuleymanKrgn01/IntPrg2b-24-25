...
{
    public class CookTypesController : Controller
    {
        ...
        // GET: CookTypes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CookTypes/Create
